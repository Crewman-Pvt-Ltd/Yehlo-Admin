...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="brand_class" class="form-control"
                                    placeholder="Enter brand class">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="h-100 d-flex align-items-center flex-column">
                                <label class="mb-3 text-center">Image<small class="text-danger">* (
                                        {{ translate('messages.ratio') }} 1:1)</small></label>
                                <label class="text-center my-auto position-relative d-inline-block">
                                    <img class="img--176 border" id="viewer"
                                        @if (isset($brand)) src="{{ asset('storage/app/public/brand') }}/{{ $brand['image'] }}"
                                    @else
    ...
    <div class="form-group">
        ...
        <img
             @if (isset($brand) && $brand->file)
                 src="{{ asset('storage/app/public/brand/' . $brand->file) }}"
           
             @endif
             />
        <input type="file" name="file" class="form-control read-url" id="customFileEg1" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" placeholder="Choose file">
                                ...
                                <td class="text-center">
                                    <div class="custom-control custom-switch d-inline-block">
                                        <input type="checkbox" class="custom-control-input status-toggle"
                                               id="statusToggle{{ $brand->id }}"
                                               {{ $brand->status == 1 ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="statusToggle{{ $brand->id }}"></label>
                                    </div>
                                </td>
